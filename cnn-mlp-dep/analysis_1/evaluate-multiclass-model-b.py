...
'''
    Analysis script IX: 
        ...
        ssh -i plankton-net.pem ec2-user@ec2-3-15-42-38.us-east-2.compute.amazonaws.com
...
for df in test_split: 
    ...
    pred_frame['file_name_x'] = df['file_name_x'].values.tolist()
    ...
    df_out = pd.merge(df, pred_frame, on = 'file_name_x', how='left')
...
test_eval.to_csv('./testing-data-preds-analysis-1-p2-pdist.csv', index=False)

''' scp testing data from remote ec2 to local machine '''

scp -i plankton-net.pem ec2-user@ec2-3-15-42-38.us-east-2.compute.amazonaws.com:~/plankton/testing-data-preds-analysis-1-p2-pdist.csv .
